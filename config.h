...
static const char *fonts[] = {"UbuntuMono-R:size=12", "JoyPixels:pixelsize=12:antialias=true:autohint=true" };
...
static const Rule rules[] = {
    ...
    {"com-st-microxplorer-maingui-STM32CubeMX", NULL, NULL, 1 << 4, 1, 0, 0,
     -1},
    {"Eclipse", NULL, NULL, 1 << 5, 0, 0, 0, -1},
    {"St", NULL, NULL, 0, 0, 1, 0, -1},
    {"Alacritty", NULL, NULL, 0, 0, 1, 0, -1},
    {"Microsoft Teams", NULL, NULL, 1 << 6, 0, 0, 0, -1},
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_equal, spawn,
     SHCMD("cd /home/evn/.scripts/brightness_control; ./brightness_increase")},
    {MODKEY | ShiftMask, XK_minus, spawn,
     SHCMD("cd /home/evn/.scripts/brightness_control; ./brightness_decrease")},
    {MODKEY, XK_m, spawn, SHCMD("pamixer -m; kill -44 $(pidof dwmblocks)")},
    {MODKEY | ShiftMask, XK_m, spawn,
     SHCMD("pamixer -u; kill -44 $(pidof dwmblocks)")},
    ...
    {MODKEY | ShiftMask, XK_c, spawn,
     SHCMD("st vim /home/evn/Projects/dwm/config.def.h")},
